      ...
      <section className="hero-foot has-text-centered">
         <div className='columns'>
            ...
            <div className='column'>
               <p><strong className="footerBack">Let's Guess</strong></p>
               ...
               <p ><strong className="footerBack">Avatars created at<a href="https://www.cartoonify.de/" target="blank"> Cartoonify</a></strong></p>
