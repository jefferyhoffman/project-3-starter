...
class Card extends Component {
  ...
  handleGuess = () => {
    ...
    if (
      this.state.guess.toLocaleLowerCase() ===
      this.state.who.toLocaleLowerCase()
    ) {
      this.handleFlip();
      alert(`you scored ${this.state.score}/10`);
    } else if (
      this.state.guess &&
      this.state.guess.toLocaleLowerCase !== this.state.who.toLocaleLowerCase()
    ) {
            ...
            <div className="tile is-parent">
              <article className="tile is-child box cardBox">
                <article className="tile is-child box">
                  ...
                  <img
                    alt="bob"
                    src="https://i.pinimg.com/564x/4f/24/7a/4f247acf992487b5f1d8bdd641f6bd50.jpg"
