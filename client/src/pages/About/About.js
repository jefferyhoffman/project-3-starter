        ...
        <div className='container'>
          <div className='card-about mb-4'>
            <div className='row no-gutters'>
              ...
              <div className='col-md-7'style={{marginLeft:'2.5%', padding:'5%'}}>
                <div className='card-body-about'>
                  <h5 className='card-title'><h1 className='pages-header'>About Drinkstation</h1></h5>
                  <div className='row'>
                    <p className='card-textabout'>Drinkstation is an application for Beverage Lovers. Drink enthusiasts who love this craft.
