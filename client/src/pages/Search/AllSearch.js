...
class AllSearch extends Component {
  ...
  handleInputChange1 = event => {
    this.setState({ drinks: [], dbdrinks: [], kind: event.target.value });
  }

  handleInputChange2 = event => {
    this.setState({ drinks: [], dbdrinks: [], category: event.target.value });
  }

  handleInputChange3 = event => {
    this.setState({ drinks: [], dbdrinks: [], liquor: event.target.value });
  }

  handleInputChange4 = event => {
    this.setState({ drinks: [], dbdrinks: [], ingredient: event.target.value });
  }

  handleInputChange5 = event => {
    this.setState({ drinks: [], dbdrinks: [], glass: event.target.value });
  };
                      ...
                      <div className='row no-gutters'>
                        ...
                        <div className='col-md-7'>
                          <div className='card-body'>
                            <h5 className='card-title'><h4>{drink.name}</h4></h5>
