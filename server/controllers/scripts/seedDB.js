...
const eventsData = [
  ...
  {
    _id: ObjectId('5d73c9d7ab2aa7245ceb4307'),
    category: 'random',
    isTaskCompleted: false,
    event_title: 'South End Shuffle',
    event_place: 'Wooden Robot Brewery',
    event_date: ISODate('2019-09-05T00:00:00.000Z'),
...
const postsData = [
  {
    _id: ObjectId('5d72ac328bd033130a84c2a9'),
    category: 'yard',
    urgent: false,
    help_needed: true,
    offering: false,
  ...
  {
    _id: ObjectId('5d72adfa3c6a481394e50c7c'),
    category: 'kids',
    urgent: true,
    help_needed: true,
    offering: false,
  ...
  {
    _id: ObjectId('5d72aef77f2f1d13d96e50d1'),
    category: 'pets',
    urgent: false,
    help_needed: false,
    offering: true,
  ...
  {
    _id: ObjectId('5d72b0e37f2f1d13d96e50d2'),
