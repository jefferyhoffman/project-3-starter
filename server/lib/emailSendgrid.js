...
// must pass in an emailType of welcome, loginInfo, or invitefriend
module.exports = (emailType, email, password) => {

  let htmlBody;
  let heading;
  let buttonAdded = `<table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="iYySZ4rAB78PLoW7vU13Bb">
  <tbody><tr>
    <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="">
    </td>
  </tr>
  </tbody></table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="3e9a495b-3e7d-4a16-a735-ff3fa1668b09"> <tbody> <tr> <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px;"> <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;"> <tbody> <tr> <td align="center" bgcolor="#FE5D61" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"> <a href="http://mysmallerfootprint.com/" style="background-color:#FE5D61; border:1px solid #f8f8f8; border-color:#f8f8f8; border-radius:6px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:30px; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid; width:180px;" target="_blank">Join</a> </td> </tr> </tbody> </table> </td> </tr> </tbody> </table>`
  ...
  if (emailType === "welcome") {
    ...
    buttonAdded = "";
  } else if (emailType === "invitefriend") {
    htmlBody = `A Friend has invited you to try Smaller Footprint: the app that helps you develop environmentally friendly habits.  If you would like to become a part of the our family, press the button below.`;
    heading = `Smaller Footprint`;
  }
    ...
    html:
      ...
      <![endif]-->
        ...
        <![endif]-->
          ...
          </tbody></table>${buttonAdded}<table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="iYySZ4rAB78PLoW7vU13Bb">
            <tbody><tr>
              <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="">
              </td>
            </tr>
